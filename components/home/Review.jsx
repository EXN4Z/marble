      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-10 items-start">
        <div className="md:col-span-1 self-start">
          <div className="bg-[#8c7c4d]/40 backdrop-blur-md border border-black/10 p-6 rounded-sm h-full flex flex-col justify-center">
            <Image className="rounded-3xl" src="/images/rate.png" alt="Hero Image" width={300} height={300} />
        ...
        <div className="md:col-span-2">
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
            {visibleReviews.map((item) => (
              <div
                key={item.id}
                className="bg-[#8c7c4d]/40 backdrop-blur-md border border-black/10 p-4 flex rounded-sm gap-4"
              >
